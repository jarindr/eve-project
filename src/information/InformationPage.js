    ...
    return (
      <div className={styles.container}>
        <div className={styles.info}>
          ...
          To Eve baker, everything is figureoutable including her phone number +66 819495879 and email <a href='mailto:contactevebaker@gmail.com'>evebaker.evebaker@gmail.com</a> where you can
